...
object PlayerCommands {
  ...
  case class TogglePlay(replyTo: ActorRef[PlayToggled]) extends MiddleTrackCommand with OnlyTrackCommand with FirstTrackCommand with LastTrackCommand
  case class ToggleShuffle(replyTo: ActorRef[ShuffleToggled]) extends MiddleTrackCommand with EmptyCommand with OnlyTrackCommand with FirstTrackCommand with LastTrackCommand
  ...
  case class EnqueueFirstTrack(track: Track, replyTo: ActorRef[FirstTrackEnqueued]) extends EmptyCommand
